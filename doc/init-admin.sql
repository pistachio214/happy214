...
(
    ...
    `type`       int(1) NOT NULL COMMENT '类型: 0目录; 1菜单; 2按钮;',
...
VALUES (1, 0, '仪表盘', '/dashboard', 'sys:home', NULL, 0, 'DashboardOutlined', 5, '2021-10-06 23:46:52', NULL, 1),
       (5, 0, '系统工具', '/utils', 'sys:tools', NULL, 0, 'RadiusSettingOutlined', 1, '2021-01-15 19:06:11',
        '2022-01-08 15:50:36', 1),
