...
VALUES (1,0,'仪表盘','/dashboard','sys:home',NULL,0,'DashboardOutlined',1,'2021-10-06 23:46:52','2022-01-19 21:35:23',1),
       (5,0,'系统工具','/utils','sys:tools',NULL,0,'RadiusSettingOutlined',2,'2021-01-15 19:06:11','2022-01-19 21:35:18',1),
       ...
       (41,6,'字典列表',NULL,'sys:dict:list',NULL,2,NULL,1,'2022-01-19 21:35:58','2022-01-19 21:38:13',1),
       (42,6,'编辑字典',NULL,'sys:dict:edit',NULL,2,NULL,1,'2022-01-19 22:49:02','2022-01-19 22:49:02',1),
       (43,6,'新增字典',NULL,'sys:dict:save',NULL,2,NULL,1,'2022-01-19 22:49:26','2022-01-19 22:49:26',1),
...
VALUES (1, '超级管理员', 'administer', '系统默认最高权限，不可以编辑和任意修改', '2021-01-16 13:29:03', '2022-01-05 22:33:59', 1),
...
VALUES (1, 1, 1, '2021-12-29 10:20:57', '2021-12-29 10:20:57', 1),
...
INSERT INTO `sys_user` (`id`, `nickname`, `username`, `password`, `avatar`, `email`, `city`, `last_login`, `created_at`,
                        `updated_at`, `status`)
VALUES (1, '超级管理员', 'admin', '$2a$10$apWMyb4PYXtWxrssCqnt0eXVG06C9y1pZPJSpA6m70gi1MzOGDbz6', NULL, NULL, NULL, NULL,
        '2021-10-02 22:44:46', NULL, 1),
       (3, '测试管理员', 'test', '$2a$10$nIoa6i2ZFfIevdTE4.x84.Jnj6nls7ybUSLB2Jm9JUSGt.uj6FM2i',
        'https://image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/5a9f48118166308daba8b6da7e466aab.jpg',
        'test@qq.com', NULL, '2021-01-30 08:20:22', '2021-01-30 08:55:57', '2022-01-08 15:56:07', 1);
...
VALUES (13, 2, 3, '2021-01-17 21:56:36', NULL, 1),
...
ALTER TABLE `sys_user`
    ADD `type` INT(3) DEFAULT 1 COMMENT '用户类型: 1管理员; 2普通用户; ' AFTER `password`;
